...
## 6 — record and draft
- Record what the answer **established**, drafted here and written on Evan's word, where the placement test sends it (elak `blueprint/principles.md` P1): a capability limit and where it is enforced is a fact about the
