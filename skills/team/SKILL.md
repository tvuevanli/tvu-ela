...
$T emails                    # the known emails — the closed set a caller may pass to `ela graphs <email>`
...
- **Role, layer and reporting line are Evan's statements**, carried from Helm's team table. Empty where he has
  not stated them; the skill does not infer a manager from an area.
